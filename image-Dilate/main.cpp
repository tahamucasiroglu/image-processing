        ...
        for (;;)
        {
            if (vCap.read(frame)) {
                ...
                for (int x = 1; x < frame.cols-1; x++)
                {
                    ...
                    {
                        if (frame.at<cv::Vec3b>(y - 1, x - 1)[0] == 255 || frame.at<cv::Vec3b>(y - 1, x)[0] == 255 || frame.at<cv::Vec3b>(y, x - 1)[0] == 255 || frame.at<cv::Vec3b>(y + 1, x)[0] == 255 || frame.at<cv::Vec3b>(y, x + 1)[0] == 255 ||frame.at<cv::Vec3b>(y + 1, x + 1)[0] == 255) {
